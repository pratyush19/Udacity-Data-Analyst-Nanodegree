...
grid.arrange(bivariate_plot(rw$fixed.acidity, 'fixed.acidity (g / dm^3)'),
             bivariate_plot(rw$volatile.acidity, 'volatile.acidity (g / dm^3)'),
             bivariate_plot(rw$citric.acid, 'citric.acid (g / dm^3)'),
             bivariate_plot(rw$residual.sugar, 'residual.sugar (g / dm^3)'),
             bivariate_plot(rw$chlorides, 'chlorides (g / dm^3)'),
             bivariate_plot(rw$free.sulfur.dioxide, 'free.sulfur.dioxide (mg / dm^3)'),
             bivariate_plot(rw$total.sulfur.dioxide, 'total.sulfur.dioxide (mg / dm^3)'),
             bivariate_plot(rw$density, 'density (g / cm^3)'),
             bivariate_plot(rw$pH, 'pH'),
             bivariate_plot(rw$sulphates, 'sulphates (g / dm^3)'),
             bivariate_plot(rw$alcohol, 'alcohol (% volume)'),
             ncol = 4)
```
...
ggplot(data = rw, aes(log10(total.acidity), pH)) +
  ...
  ggtitle('pH Relation on Wine Quality')
